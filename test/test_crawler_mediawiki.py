...
class CrawlerMediawikiTestCase(TestCase):
	...
	def test_dataset(self):
		...
		self.assertEqual(self.Harvester.record["contribute"][0]["date"], "2016-02-14T14:08:47Z")
		self.assertEqual(self.Harvester.record["location"], "http://examplewiki.com/Mercurius_(planeet)")
		self.assertEqual(self.Harvester.record["relation"][0]["resource"]["catalogentry"][0]["entry"], "http://examplewiki.com/index.php?title=Mercurius_(planeet)&oldid=432728")
		self.assertIn("mercurius",self.Harvester.record["keyword"])
		self.assertIn("PO",self.Harvester.record["educational"][0]["context"])
